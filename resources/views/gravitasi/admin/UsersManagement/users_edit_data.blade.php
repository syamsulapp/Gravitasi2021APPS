    ...
    <!-- // menunya -->
        ...
        <!-- end header -->
            ...
            <div class="container-fluid">
                ...
                <!-- begin tambha data -->
                <form action="{{ url('/admin/users-view') }}{{ ('/') }}{{ $editdata->id }}{{ ('/')  }}{{ ('ubah')  }}" method="POST">
                    @method('put')
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Nama</label>
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="inputEmail4" placeholder="Nama" value="{{ $editdata->name }}">
                            @error('nama')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputPassword4" placeholder="email" value="{{ $editdata->email }}">
                            @error('email')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="nama_sekolah" class="form-control @error('nama_sekolah') is-invalid @enderror" id="inputCity" value="{{ $editdata->namasekolah }}" placeholder="{{ ('nama sekolah') }}">
                            @error('nama_sekolah')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <a href="{{ url('admin/users-management') }}" type="submit" class="btn btn-primary">Kembali</a>
                </form>
                <!-- //end tambha data -->
            </div>
            <!-- End of Main Content -->
