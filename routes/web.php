...
Route::prefix('users')->group(function () {
    ...
    Route::get('/jadwal_lomba', [\App\Http\Controllers\users\DashboardUsersController::class, 'jadwal_lomba'])->name('dashboard')->middleware(['roleadmin', 'roleadminkeuangan']);
    Route::get('/detail_jadwal/{detail}/detail', [\App\Http\Controllers\users\DashboardUsersController::class, 'detail_jadwal'])->name('dashboard')->middleware(['roleadmin', 'roleadminkeuangan']);
});
...
Route::prefix('adminkeuangan')->group(function () {
    ...
    Route::get('/konfirmasi_pembayaran', [\App\Http\Controllers\Admin\Keuangan\KeuanganController::class, 'konfirmasi_pembayaran'])->name('konfirmasi_pembayaran')->middleware(['roleusers', 'roleadmin']);
    Route::get('/sudah_membayar', [\App\Http\Controllers\Admin\Keuangan\KeuanganController::class, 'sudah_membayar'])->name('sudah_membayar')->middleware(['roleusers', 'roleadmin']);
});
